        ...
        <main className="p-4">
          ...
          <div className="mt-8 flex space-x-4">
            <a
              ...
              rel="noopener noreferrer"
            >
              <button className="bg-blue-500 text-white px-4 py-2 rounded"><FaSquareXTwitter /> </button>
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <button className="bg-green-500 text-white px-4 py-2 rounded"><FaWhatsapp /> </button>
            </a>
          </div>
        </main>
      </div>
